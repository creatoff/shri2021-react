  ...
  return ( 
    <>
      ...
      <form ref={elForm} onSubmit={handleSubmit}>
        <FormField placeholder="Commit hash" name="hash"></FormField>
        <Toolbar>
          <Button theme="action" type="submit" >Run build</Button>
          <Button theme="pseudo" onClick={handleCancel}>Cancel</Button>
        </Toolbar>
      </form>
    </>
   );
